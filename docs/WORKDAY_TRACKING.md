<!-- Status: cancelled 2026-09-16, reinstated 2026-09-21 at the backend team's
     request (docs/MOBILE_APP_TRACKING_ISSUE.md). The contract below is the one
     `backend/dh_workday_tracking` implements and the app speaks again. -->
