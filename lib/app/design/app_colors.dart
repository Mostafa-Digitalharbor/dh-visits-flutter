...
// Hex values are 1:1 with docs/design/flutter_build/01-foundations.md.
// Extra semantic tokens live in AppX (see theme.dart).
...
class AppColors {
  ...
  static const lightScheme = ColorScheme(
    ...
    inverseSurface: Color(0xFF2A2839), onInverseSurface: Color(0xFFF6F5FB),
    inversePrimary: Color(0xFFBAC0E6),
  );
  ...
  static const darkScheme = ColorScheme(
    ...
    inverseSurface: Color(0xFFECECF4), onInverseSurface: Color(0xFF2A2839),
