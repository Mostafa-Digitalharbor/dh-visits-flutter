...
class LocationDescriber {
  ...
  String _format(Placemark p, String? locale) {
    ...
    final seen = <String>{};
    // Arabic comma only for Arabic — this label is stored on the visit and read
    // back by whoever reviews it, so an English label must read as English.
    final separator = (locale ?? 'en').startsWith('ar') ? '، ' : ', ';
